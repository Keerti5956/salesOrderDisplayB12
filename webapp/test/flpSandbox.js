		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#appsalesorderdisplay-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appsalesorderdisplay-display": {
								"semanticObject": "appsalesorderdisplay",
								"action": "display",
								"description": "SO for Partners",
								"title": "Sales Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.salesorderdisplay",
									"url": sap.ui.require.toUrl("app/salesorderdisplay")
								}
							}
						}
					}
